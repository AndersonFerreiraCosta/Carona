...
require_once ("../controller/carona.controller.class.php");
require_once ("../model/carona.class.php");


$Ucontroller = new UsuarioController ();
$usuario = new usuarios();

$Ccontroller = new CaronaController();
$carona = new carona();
?>
...
if (isset ( $_POST ['submit'] )) {
	...
	session_start ();
	if ($Ucontroller->login ( $email, $senha ) == true) {
		
		$registros = $Ucontroller->listaUsuarioCompleto ( $Ucontroller->pegarId() );
					...
					<div class="col-md-6">
						<div class="col-md-12">
							...
							<ul class="contact-info">
								<li><i class="glyphicon glyphicon-user"></i><?php echo $reg['nome']?></li>
								<li><i class="ti-map"></i><?php echo $reg['cidade']?></li>
								<li><i class="ti-mobile"></i><?php echo $reg['telefone']?></li>
								<li><i class="ti-envelope"></i><?php echo $reg['email']?></li>
								<li><i class="flaticon-car"></i><?php echo $reg['modelo']?></li>
							</ul>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<div class="copyright">
							<p>
								<small>&copy; 2016 Free HTML5 Template. <br> All Rights
									Reserved. <br> Designed by <a href="http://freehtml5.co"
									target="_blank">FreeHTML5.co</a> <br> Demo Images: <a
								...
								<form action="#" id="form-subscribe">
									<div class="form-field">
										<input type="email" placeholder="Email Address" id="email"> <input
											type="submit" id="submit" value="Send">
									</div>
								</form>
							</div>
						</div>
